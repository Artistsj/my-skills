...
```text
You have access to a local skill named market-daily-review at:
<MARKET_DAILY_REVIEW_SKILL_ROOT>
When the user request matches this skill's SKILL.md description:
1. Read <MARKET_DAILY_REVIEW_SKILL_ROOT>/SKILL.md.
2. Follow the workflow and guardrails in that file exactly.
3. Load referenced files under <MARKET_DAILY_REVIEW_SKILL_ROOT>/references/ only when needed.
